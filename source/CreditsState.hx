...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Infinity Engine Devs'],
			['h4mster',				'h4m',						'Main programmer',												'https://github.com/h4master',			'6F00CC'],
			...
			['Keoiki',				'psych/keoiki',				'Note Splash Animations',										'https://twitter.com/Keoiki_',			'D2D2D2'],
			['Nebula the Zorua',	'psych/nebula',				'LUA JIT Fork and some Lua reworks',							'https://twitter.com/Nebula_Zorua',		'7D40B2'],
