...
class Achievements {
	...
	public static function loadAchievements():Void {
		if(Paths.save.data != null) {
			if(Paths.save.data.achievementsMap != null) {
				achievementsMap = Paths.save.data.achievementsMap;
			}
			if(henchmenDeath == 0 && Paths.save.data.henchmenDeath != null) {
				henchmenDeath = Paths.save.data.henchmenDeath;
			}
		}
	}
}
...
class AchievementObject extends FlxSpriteGroup {
	...
	public function new(name:String, ?camera:FlxCamera = null)
	{
		...
		achievementBG.y = FlxG.height - achievementBG.height - 50;
		...
		alpha = 0;
		achievementBG.cameras = [FlxG.cameras.list[FlxG.cameras.list.length - 1]];
		achievementName.cameras = [FlxG.cameras.list[FlxG.cameras.list.length - 1]];
		achievementText.cameras = [FlxG.cameras.list[FlxG.cameras.list.length - 1]];
		achievementIcon.cameras = [FlxG.cameras.list[FlxG.cameras.list.length - 1]];
